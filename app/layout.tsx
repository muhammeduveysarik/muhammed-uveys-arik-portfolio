...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXTAUTH_URL ?? 'https://muhammeduveysa.dev'),
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    url: 'https://muhammeduveysa.dev',
    sameAs: ['https://github.com/muhammeduveysarik', 'https://www.linkedin.com/in/muveys/'],
  }

  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        <meta name="google-site-verification" content="qG7rhwqBH_cJnVTj-OBMzhbfJ9_88LxD57-By64STvE" />
      ...
      <body
        className={`${inter.variable} ${jetbrainsMono.variable} font-sans bg-[#0a0a0f] text-gray-100 antialiased`}
      >
        {children}

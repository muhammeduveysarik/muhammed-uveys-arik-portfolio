...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className={`max-w-[1200px] mx-auto px-6 text-center transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* Profile photo */}
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4">
          <span className="gradient-text">Muhammed Üveys Arık</span>
        </h1>
        ...
        <p className="max-w-2xl mx-auto text-gray-400/80 text-base sm:text-lg leading-relaxed mb-10">
          I&apos;m a Computer Engineering student currently learning and developing my technical skills across software, systems, and networking. I&apos;m focused on building a strong engineering foundation while exploring areas like backend development, Linux, and cloud technologies.
        </p>

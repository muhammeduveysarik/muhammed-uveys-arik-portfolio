    ...
    >
      ...
      >
        ...
        <p className="max-w-2xl mx-auto text-gray-400/80 text-base sm:text-lg leading-relaxed mb-10">
          I&apos;m a Computer Engineering student exploring different areas of
          technology through hands-on projects. I&apos;m currently developing
          my skills across Data, Artificial Intelligence, DevOps, Cloud, and
          Cybersecurity while building a strong foundation in software
